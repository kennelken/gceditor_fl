...
part of 'db_cmd_add_data_row.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DbCmdAddDataRow _$DbCmdAddDataRowFromJson(Map<String, dynamic> json) =>
    DbCmdAddDataRow()
      ...
      ..tableRowValues = json['tableRowValues'] == null
          ...
          : DataTableRow.fromJson(
              json['tableRowValues'] as Map<String, dynamic>);

Map<String, dynamic> _$DbCmdAddDataRowToJson(DbCmdAddDataRow instance) {
  ...
  writeNotNull('tableRowValues', instance.tableRowValues?.toJson());
  return val;
}
