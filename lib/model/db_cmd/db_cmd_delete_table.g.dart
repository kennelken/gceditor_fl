...
part of 'db_cmd_delete_table.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DbCmdDeleteTable _$DbCmdDeleteTableFromJson(Map<String, dynamic> json) =>
    DbCmdDeleteTable()
      ..id = json['id'] as String
      ..$type = $enumDecodeNullable(_$DbCmdTypeEnumMap, json[r'$type'])
      ..entityId = json['entityId'] as String;

Map<String, dynamic> _$DbCmdDeleteTableToJson(DbCmdDeleteTable instance) {
